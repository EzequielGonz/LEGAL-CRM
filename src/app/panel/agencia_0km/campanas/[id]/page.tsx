...
export default async function CampaignDetail0kmPage({ params }: { params: { id: string } }) {
  const supabase = createClient();

  // eq("area", "agencia_0km") además del id: evita que, poniendo a mano la
  ...
  return (
    <div>
      <Link
        href="/panel/agencia_0km/campanas"
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-start gap-2">
          ...
          <DeleteCampaignButton
            campaignId={campaign.id}
            campaignName={campaign.name}
            redirectTo="/panel/agencia_0km/campanas"
          />
        </div>
      </div>
