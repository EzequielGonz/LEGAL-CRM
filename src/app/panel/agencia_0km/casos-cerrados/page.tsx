...
const AREA = "agencia_0km" as const;

/**
 * Versión de "Casos cerrados" exclusiva de Agencia 0KM: mismo criterio de
 * cierre que Jurídico (status cerrado_ganado / cerrado_perdido), pero
 * siempre filtrado por area = "agencia_0km" para que nunca se mezcle con
 * los clientes cerrados de Jurídico ni de ningún otro rubro.
 */
export default async function Casos0kmPage({
  searchParams,
}: {
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Clientes de Agencia 0KM marcados como cerrados (ganados o perdidos) desde su ficha.
          </p>
        </div>
      </div>
      ...
      <form
        action="/panel/agencia_0km/casos-cerrados"
        method="GET"
      ...
      >
        ...
        {hasFilters && (
          <Link
            href="/panel/agencia_0km/casos-cerrados"
              ...
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-slate-400">
                  {hasFilters
                    ...
                    : "Todavía no hay ningún cliente cerrado de Agencia 0KM."}
                </td>
              </tr>
            )}
          </tbody>
