...
export default async function ConfiguracionMarketingPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <h1 className="text-2xl font-semibold text-slate-900">Configuración — Marketing</h1>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mb-3 text-xs text-slate-400">
          ...
          las variables de entorno del servidor en Vercel (WHATSAPP_MARKETING_PHONE_NUMBER_ID /
          WHATSAPP_MARKETING_ACCESS_TOKEN).
        </p>
